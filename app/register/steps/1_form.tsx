      ...
      <div className="w-72 sm:w-72 md:w-72 lg:w-96 xl:w-96">
        ...
        >
          <p className="text-sm italic text-slate-500">
            En t'inscrivant sur la plateforme{" "}
            <span className="text-orange-400">An’gova</span>, tu acceptes nos{" "}
        ...
        <div className="fixed bottom-0 left-0 right-0 mb-5 pb-20">
          <motion.div
            ...
            variants={{
              ...
              hidden: { y: -80, scale: 1.1, overflow: "hidden" },
            }}
  ...
  return (
    ...
    >
      <div className="w-full">
        <p className="font-bold text-2xl text-center my-5">Register</p>
